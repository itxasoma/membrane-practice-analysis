...
Reads:
    figures/2.corr_<tag>_<TEMP_TAG>.csv

Writes:
    figures/2.corr_<TEMP_TAG>.pdf
    figures/2.corr_pairs_<TEMP_TAG>.pdf
"""
...
# ── Change this to match the temperature you ran corr.py for ──────────────────
TEMP_TAG = "290.5"
# ─────────────────────────────────────────────────────────────────────────────
